...
const simulatedRepos: RepositoryInfo[] = [
  ...
  { name: 'legal', full_name: 'heyns1000/legal', description: 'all legal minutes of meetings, documents and a global legal index for all respitories', language: 'HTML', topics: [], private: false, fork: false, archived: false, has_license: false },
